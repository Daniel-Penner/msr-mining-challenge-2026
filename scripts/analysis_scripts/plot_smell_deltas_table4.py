...
# Print summary statistics per agent
print("\n--- Smell Delta Summary per Agent ---")
summary = df.groupby("agent").agg(
    mean_before=("smells_before", "mean"),
    median_before=("smells_before", "median"),
    mean_after=("smells_after", "mean"),
    median_after=("smells_after", "median"),
